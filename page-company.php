...
<section>
  <div class="container-small">
    <h3 class="d-block f-24 mincho mb-5">継続は力なり<br>「寿司のむさし」を支える確かな実績</h3>
    <p class="lh-large">1977年、京都の河原町三条に堂々オープンして以来四十余年、今も変わらず営業させていただいてるのも『お客様』あってのこと…。<br>今もその気持ちを忘れず、日々精進しております。<br>お客様に愛されるお寿司を提供できる秘密は、長年培ってきた実績と経験が生きているんですね。</p>
    <!-- ▼ 会社概要 -->
    <h2 class="ttl-2 mb-5 mt-5">会社概要<span class="ttl-2-en en">profile</span></h2>
    <table class="w-100 mt-3">
      <tr class="athome__support-lines d-flex w-100">
        <td class="athome__support-item main bg-light col-5">社名</td>
        <td class="athome__support-item sub col-7">株式会社　花洛（からく）</td>
      </tr>
      <tr class="athome__support-lines d-flex w-100">
        <td class="athome__support-item main bg-light col-5">創業</td>
        <td class="athome__support-item sub col-7">昭和20年12月5日</td>
      </tr>
      <tr class="athome__support-lines d-flex w-100">
        <td class="athome__support-item main bg-light col-5">資本金</td>
        <td class="athome__support-item sub col-7">38,350千円</td>
      </tr>
      <tr class="athome__support-lines d-flex w-100">
        <td class="athome__support-item main bg-light col-5">従業員数</td>
        <td class="athome__support-item sub col-7">150名（内正社員40名）</td>
      </tr>
      <tr class="athome__support-lines d-flex w-100">
      ...
      <tr class="athome__support-lines d-flex w-100">
        ...
        <td class="athome__support-item sub col-7">回転寿司店の経営（直営2店舗）</td>
      </tr>
      <tr class="athome__support-lines d-flex w-100">
